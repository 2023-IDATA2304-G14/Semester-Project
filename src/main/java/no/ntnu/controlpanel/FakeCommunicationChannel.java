...
//   */
//  public void spawnNode(int nodeId, int sensorId, int delay) {
...
//   * @param delay      Delay in seconds
//   */
//  public void advertiseSensorData(int nodeId, int sensorId, double value, int delay) {
//    Timer timer = new Timer();
//    timer.schedule(new TimerTask() {
//      @Override
//      public void run() {
//        logic.onSensorData(nodeId, sensorId, value);
//      }
//    }, delay * 1000L);
//  }
//
