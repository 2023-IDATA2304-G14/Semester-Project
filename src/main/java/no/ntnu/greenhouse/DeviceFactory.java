...
public class DeviceFactory {
  ...
  public static Sensor createHumiditySensor(int nodeId) {
    return new Sensor(nodeId, SENSOR_TYPE_HUMIDITY, MIN_HUMIDITY, MAX_HUMIDITY,
  ...
  public static Actuator createWindow(int nodeId) {
    Actuator actuator = new Actuator(nodeId, ACTUATOR_TYPE_WINDOW, 1, 1, 0, "");
  ...
  public static Actuator createFan(int nodeId) {
    Actuator actuator = new Actuator(nodeId, ACTUATOR_TYPE_FAN, 50, 100, 0, "%");
  ...
  public static Actuator createHeater(int nodeId) {
    Actuator actuator = new Actuator(nodeId, ACTUATOR_TYPE_HEATER, 20, 40, 0, "°C");
