...
public class ControlPanelStarter {
  ...
  private CommunicationChannel initiateFakeSpawner(ControlPanelLogic logic) {
    ...
    spawner.advertiseActuatorState(4, 1, true, 1, 5);
    spawner.advertiseActuatorState(4,  1, false, 0, 6);
    spawner.advertiseActuatorState(4,  1, true, 1, 7);
    spawner.advertiseActuatorState(4,  2, true, 1, 7);
    spawner.advertiseActuatorState(4,  1, false, 0, 8);
    spawner.advertiseActuatorState(4,  2, false, 0, 8);
    spawner.advertiseActuatorState(4,  1, true, 1, 9);
    spawner.advertiseActuatorState(4,  2, true, 1, 9);
